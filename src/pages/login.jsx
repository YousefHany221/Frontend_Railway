...
// 🌐 قاموس الترجمة لصفحة الـ Login
const translations = {
  en: {
    subtitle: "Newborn Biometric ID",
    email: "Email*",
  ...
  ar: {
    subtitle: "التعريف البيومتري للمواليد",
    ...
    errPass: "كلمة المرور غير صحيحة"
  },
  fr: {
    subtitle: "Identifiant Biométrique Néونé",
    email: "E-mail*",
    emailPlaceholder: "email@example.com",
    ...
    register: "S'inscrire",
    errEmail: "Veuillez entrer un e-mail valide",
...
function Login() {
  ...
  // 🌍 بنقرأ اللغة الحالية المتخزنة في المتصفح بناءً على الـ Dropdown
  ...
  const handleLogin = async () => {
    ...
    if (Object.keys(e).length === 0) {
      ...
      // 🚀 شحن كود اللغة الحالي في الـ Headers للباكيند
  ...
  return (
    <AuthLayout>
      ...
      {/* 👑 قلب الاتجاه بالكامل يمين أو شمال حسب اللغة */}
      <div className="w-full max-w-sm space-y-4" style={{ direction: currentLang === "ar" ? "rtl" : "ltr" }}>
