...
const stats = [
  ...
  { label: "Verified Children", value: 1, color: "bg-green-100", textColor: "text-green-600", icon: "✅" },
  { label: "Verifications", value: 1, color: "bg-yellow-100", textColor: "text-yellow-600", icon: "⏳" },
];
        ...
        <table className="w-full">
          <thead>
            <tr className="border-b border-gray-100">
              {["Child Name", "Mother", "Status", "Last Check"].map(h => (
              ...
              <tr key={i} className="border-b border-gray-50 hover:bg-gray-50 transition">
                <td className="px-6 py-3">
                  <div className="flex items-center gap-3">
                    <div className="w-8 h-8 rounded-full bg-blue-100 flex items-center justify-center text-blue-600 font-semibold text-sm">{child.avatar}</div>
